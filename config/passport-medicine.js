...
module.exports = function(schema, options) {
    ...
    options.itemNameField	= options.itemNameField  || 'itemName';
    options.categoryField   = options.categoryField  || 'category';
    options.classification	= options.classification || 'classification';
    options.dose_weight 	= options.dose_weight 	 || 'dose_weight';
    options.addNotesField   = options.addNotesField	 || 'email';
    options.idItem       	= options.passwordField  || 'password';
    ...
    inventoryIn:        { type: String, default: '[]' },
    inventoryOut:       { type: String, default: '[]' },
